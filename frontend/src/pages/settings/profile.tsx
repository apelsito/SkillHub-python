...
/** Regex matching allowed display name characters: letters, digits, spaces, underscore, hyphen. */
const DISPLAY_NAME_PATTERN = /^[\p{L}\p{M}0-9_ -]+$/u
...
const FIELD_VALIDATORS: Record<string, FieldValidator> = {
  ...
  avatarUrl: (value, t) => {
    ...
    try {
      ...
      if (url.protocol !== 'http:' && url.protocol !== 'https:') return t('profile.validation.avatarUrl')
    } catch {
      return t('profile.validation.avatarUrl')
    }
    return null
  },
}
                ...
                <div key={field} className="space-y-2">
                  ...
                  {isEditing && policy.editable ? (
                    <Input
                      ...
                      maxLength={field === 'displayName' ? 32 : field === 'avatarUrl' ? 512 : undefined}
