...
test.describe('Search Input (Real API)', () => {
  ...
  // TC_SEARCH_INPUT_009 P0 - multi-word keyword search
  test('TC_SEARCH_INPUT_009: supports multi-word keyword search without error', async ({ page }) => {
    await page.goto(searchUrl('test skill'))
    await expect(page).toHaveURL(/\/search/)
